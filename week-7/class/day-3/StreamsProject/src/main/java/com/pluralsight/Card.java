...
public abstract class Card implements SellingInterface, TradingInterface {
    ...
    public void sell() {
        System.out.println("We've sold the card " + this.cardNumber);
    }

    public void trade() {
        System.out.println("We've traded the card " + this.cardNumber);
    }
